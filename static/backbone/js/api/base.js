require.config({
    paths: {
        ...
        'highcharts': '../external/highcharts/highcharts',
        'highcharts_export': '../external/highcharts/highcharts/modules/exporting',
        'jquery': '../external/jquery-1.8.0.min',
        'jquery.bootstrap': '../external/bootstrap.min',
        'jquery.ui': '../external/jquery-ui.min',
        'kernel': '../external/kernel.min',
        'mapplication-built':'../api-build/mapplication',
